            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  className="form-control"
                  placeholder="Innovation lab, campus expo hall, client office, or project location"
                  value={form.showcaseLocation}
                  onChange={handleChange}
                />
                <span style={{ fontSize: '0.75rem', color: 'var(--gray-500)' }}>This adds a Google Maps preview to the project details page.</span>
              </div>
